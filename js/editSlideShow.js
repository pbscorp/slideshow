...
function getHelpXX(subject) {
    ...
    if (subject && subject == "text") {
        ...
        myModal.innerHTML += '<li>&nbsp&nbsp&nbspMedia file names should be re-named to that the basename matches the slide name</li>';
        myModal.innerHTML += '</ul>';
    }
}
